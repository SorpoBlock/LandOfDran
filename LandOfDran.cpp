...
int main(int argc, char* argv[])
{
	...
	SDL_Window* window = SDL_CreateWindow("Land of Dran", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 1024, 1024, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
