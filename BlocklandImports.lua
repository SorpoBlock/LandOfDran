...
--scaled by its Blockland brightness over the basic lights' 9. Corona width is its flare's NearSize
local function blocklandLight(uiName, r, g, b, radius, brightness, coronaWidth)
...
--Light_Animated add-on. Our lights can't animate, so these get about the color, radius, and brightness they average
blocklandLight("Yellow Blink", 1, 1, 0, 10, 5, 3)	--Blinks, on a bit over half the time
blocklandLight("Strobe", 0.7, 1, 1, 15, 13, 1)		--Brightness 30 flashing on and off
