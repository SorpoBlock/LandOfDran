...
void populateDefaults(SettingManager& settings)
{
	...
	*/
	...
	settings.addFloat("input/mousesensitivity",		1.0f, false, 	"Mouse Sensitivitiy");
	...
	//GUI Settings
	settings.addFloat("gui/opacity",				0.8f, false,		"HUD Opacity");
	settings.addEnum("gui/scaling",					1, 				"GUI Scaling Factor", 	{"Small","Normal","Large","Largest"});

	//Audio settings
	settings.addFloat("audio/mastervolume",			0.5f, false,		"Master Volume");
	settings.addFloat("audio/musicvolume",			0.5f, false,		"Music Volume");
